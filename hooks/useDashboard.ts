...
import type { DashboardData, OpportunityData, FundingRateData } from '@/types/api';
  ...
  const fetchOpportunities = useCallback(async () => {
    ...
    try {
      ...
      const [allOpportunities, topOps] = await Promise.all([
        ...
        dashboardAPI.getTopOpportunities(4),
      ]);
...
export const useFundingRates = (): UseFundingRatesResult => {
